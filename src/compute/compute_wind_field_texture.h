#ifndef COMPUTE_WIND_FIELD_TEXTURE_H
#define COMPUTE_WIND_FIELD_TEXTURE_H
...
class ComputeWindFieldTexture : public ComputeTask
{
public:
	ComputeWindFieldTexture() = default;
	~ComputeWindFieldTexture() override = default;

	const char* DebugName() const override
	{
		return "ComputeWindFieldTexture";
	}
