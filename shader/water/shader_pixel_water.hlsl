...
float4 main(PS_INPUT ps_in) : SV_TARGET
{
    ...
    const float shallow_normal_fade = smoothstep(0.08f, 0.35f, water_depth);
    ...
    const float depth_opacity = smoothstep(0.12f, 0.65f, water_depth) * max(diffuse_color.a, 0.68f);
